        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            ...
            <p style={{
              ...
              Coach.AI helps endurance coaches save hours each week on training
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {[
            ...
            },
            {
              ...
              body: "Coach.AI reads the check-in, looks at their training plan, and drafts a reply in your voice — not a chatbot's.",
